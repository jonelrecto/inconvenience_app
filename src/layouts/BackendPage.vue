<template>
  <q-layout view="hHh LpR fFf" class="bg-grey-3">
    <q-header class="bg-grey-3 text-grey-9" reveal height-hint="60">
      <q-toolbar class="bg-primary text-grey-6">
        <!-- <q-btn
        ...
        <div class="q-pr-lg" v-if="$q.screen.gt.xs" @click="$router.push('/admin')" style="cursor: pointer">
          <img class="GPLAY__logo" :src="require('../assets/White-Incon.png')">
        </div>
            ...
            <q-menu>
              <div class="row no-wrap q-pa-md">
                <!-- <div class="column">
                  ...
                  <q-btn size="sm" color="primary" icon="mdi-account-edit" label="Profile " />
    ...
    >
      <q-list>
        ...
        <q-item clickable class="GPLAY__drawer-link GPLAY__drawer-link--apps" to="/admin">
        ...
        <q-item clickable class="GPLAY__drawer-link GPLAY__drawer-link--movies" to="/admin/requestedquotes">
          ...
          <q-item-section class="movies-text">
            <q-item-label>Request Quotes</q-item-label>
          </q-item-section>
        </q-item>

        <q-item clickable class="GPLAY__drawer-link GPLAY__drawer-link--music" to="/admin/claimlistingusers">
          <q-item-section avatar class="music-icon bg-orange-7 text-grey-1 text-center">
            <q-icon name="mdi-account-badge" />
          </q-item-section>
          <q-item-section class="music-text">
            <q-item-label>Claim Listing Owners</q-item-label>
          </q-item-section>
        </q-item>

        <q-item clickable class="GPLAY__drawer-link GPLAY__drawer-link--books" to="/admin/users">
          <q-item-section avatar class="books-icon bg-blue-7 text-grey-1 text-center">
            <q-icon name="mdi-account-box-multiple" />
          </q-item-section>
